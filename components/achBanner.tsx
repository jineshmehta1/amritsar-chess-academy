  ...
  return (
    <section className="relative h-[85vh] min-h-[100vh] w-full overflow-hidden flex items-center justify-center pt-20">
      ...
      <div 
        ...
        style={{
          backgroundImage: `url('/achbg.avif')`, // Background showing trophies/chess focus
        ...
        >
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-[10px] md:text-xs font-bold tracking-[0.5em] uppercase text-zinc-300">
              Amritsar Chess Club • A Legacy of Triumph
            </span>
            <span className="w-8 h-[1px] bg-[#2b5292]" />
          </div>
          ...
          <p className="max-w-3xl mx-auto text-sm md:text-lg text-zinc-400 font-light tracking-wide leading-relaxed">
            ...
            tells the story of dedication and strategic brilliance. Since 2010, 
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-10 pt-12 border-t border-white/10 w-full max-w-3xl">
            <div className="flex flex-col items-center gap-2">
              <Medal className="text-[#2b5292]" size={24} />
              <div className="flex flex-col">
                <span className="text-xl font-bold font-serif">50+</span>
                <span className="text-[9px] tracking-[0.2em] uppercase text-zinc-400 font-bold">State Titles</span>
              </div>
            </div>
            <div className="flex flex-col items-center gap-2">
              <Star className="text-[#2b5292]" size={24} />
              <div className="flex flex-col">
                <span className="text-xl font-bold font-serif">14+</span>
                <span className="text-[9px] tracking-[0.2em] uppercase text-zinc-400 font-bold">Years of Legacy</span>
              </div>
            </div>
            <div className="flex flex-col items-center gap-2">
              <Trophy className="text-[#2b5292]" size={24} />
              <div className="flex flex-col">
                <span className="text-xl font-bold font-serif">200+</span>
                <span className="text-[9px] tracking-[0.2em] uppercase text-zinc-400 font-bold">Trophies Won</span>
              </div>
            </div>
          </div>
        </motion.div>
