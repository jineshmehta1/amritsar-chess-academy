...
import { ChevronRight, MessageCircle, ImageIcon } from "lucide-react"
  ...
  return (
    <section className="relative h-[85vh] min-h-[100vh] w-full overflow-hidden flex items-center justify-center pt-20">
      ...
      <div 
        ...
        style={{
          backgroundImage: `url('https://images.unsplash.com/photo-1586165368502-1bad197a6461?q=80&w=2070&auto=format&fit=crop')`, 
        ...
        >
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-[10px] md:text-xs font-bold tracking-[0.5em] uppercase text-zinc-300">
              Amritsar Chess Club • Visual Legacy
            </span>
            <span className="w-8 h-[1px] bg-[#2b5292]" />
          </div>
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif italic tracking-tight leading-[1.1]">
            A Decade of Strategy, <br />
            <span className="font-sans not-italic font-light tracking-wide text-zinc-200">
              Captured in Every Move.
            </span>
          </h1>

          {/* Refined Body Text */}
          <p className="max-w-3xl mx-auto text-sm md:text-lg text-zinc-400 font-light tracking-wide leading-relaxed">
            From intense tournament halls to the quiet focus of our training rooms. 
            Explore the journey of our students as they transform from local 
            aspirants into international contenders.
          </p>
      ...
      {/* Decorative Bottom Gradient for seamless transition to gallery grid */}
