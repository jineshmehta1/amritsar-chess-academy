      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start mb-20">
          ...
          <motion.div 
            ...
            className="lg:col-span-4 bg-slate-50 rounded-[2.5rem] -p-10 relative overflow-hidden h-full min-h-[600px] flex flex-col"
          >
            <div className="relative z-10">
              <div className="w-14 h-14 rounded-2xl bg-white shadow-sm flex items-center justify-center mb-8">
                <HelpCircle size={32} style={{ color: orange }} />
              </div>
              <h3 className="text-3xl font-black leading-tight mb-6 text-[#12123D]">
                Got Questions? <br />
                We're Here to Help!
              </h3>
            ...
            {/* Decorative Chess Piece Image */}
            <img 
              src="/king1.png" 
              alt="Chess King" 
              className="absolute bottom-0 right-[-20%] w-[80%] h-auto opacity-100 grayscale"
            />
          </motion.div>
              ...
              >
                ...
                >
                  ...
                  >
                    {openIndex === index ? (
                      ...
                      <Plus size={16} style={{ color: orange }} />
                    )}
                  </div>
                  <span className="flex-grow font-black text-[#12123D] text-sm md:text-base">
                    {faq.question}
                  </span>
                  <ChevronDown 
                    size={20} 
                ...
                <AnimatePresence>
                  {openIndex === index && (
                    ...
                    >
                      <div className="px-16 pb-8 text-slate-500 font-medium text-sm leading-relaxed">
                        {faq.answer}
                      </div>
                    </motion.div>
                  )}
        ...
        <motion.div 
          ...
          className="bg-white rounded-[2.5rem] p-8 md:p-10 shadow-[0_10px_50px_rgba(0,0,0,0.05)] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 border border-slate-50"
        >
          {/* Still Have Questions */}
          <div className="flex items-center gap-5 px-4">
            <div className="w-14 h-14 rounded-full flex items-center justify-center bg-[#12123D] text-white">
              <Headset size={24} />
            </div>
            <div>
              <div className="text-base font-black text-[#12123D]">Still Have Questions?</div>
              <div className="text-xs font-bold text-slate-400">Our team is happy to help you find the right path.</div>
            </div>
          </div>

          {/* Email Us */}
          <div className="flex items-center gap-5 px-4 lg:border-l border-slate-100">
            <div className="w-14 h-14 rounded-full flex items-center justify-center bg-white shadow-md" style={{ color: orange }}>
              <Mail size={24} fill="currentColor" className="text-orange-500 fill-white" strokeWidth={2.5} />
            </div>
            <div>
              <div className="text-base font-black text-[#12123D]">Email Us</div>
              <div className="text-xs font-bold text-orange-600">support@chessclub.com</div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-5 px-4 lg:border-l border-slate-100">
            ...
            <div>
              <div className="text-base font-black text-[#12123D]">Call Us</div>
              <div className="text-xs font-bold text-slate-500">+91 98765 43210</div>
            </div>
          </div>

          {/* Chat With Us */}
          <div className="flex items-center gap-5 px-4 lg:border-l border-slate-100 relative">
            ...
            <div>
              <div className="text-base font-black text-[#12123D]">Chat With Us</div>
              <div className="text-xs font-bold text-slate-500">Click the chat icon on our website to connect</div>
            </div>
            {/* Small decorative pawn like in the image */}
            <img src="https://cdn-icons-png.flaticon.com/512/3645/3645851.png" className="absolute right-0 bottom-0 w-8 h-8 opacity-10" alt="pawn" />
          </div>
        </motion.div>
      </div>
    </section>
